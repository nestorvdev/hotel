...
INSERT INTO `bookingApp`.`city` (name,country)
...
INSERT INTO `bookingApp`.`category` (title,description,url)
...
-- 1
INSERT INTO `bookingApp`.`product` (name,description,idCity,idCategory,latitude,longitude,address,qualification,reference,rules,health,politics,deleted)
...
INSERT INTO `bookingApp`.`score` (idUser,score,idProduct)
VALUES (1,5,1);
...
INSERT INTO `bookingApp`.`image` (title,url,idProduct)
...
INSERT INTO `bookingApp`.`feature` (title,type)
VALUES ('wifi',0);
INSERT INTO `bookingApp`.`feature` (title,type)
VALUES ('pileta',1);
INSERT INTO `bookingApp`.`feature` (title,type)
...
INSERT INTO `bookingApp`.`featurePerProduct` (idFeature,idProduct)
VALUES (1,1);
...
INSERT INTO `bookingApp`.`reservation`(arrivalSchedule, endDate, startDate,idProduct,idUser)
